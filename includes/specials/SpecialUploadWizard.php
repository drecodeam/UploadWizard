...
class SpecialUploadWizard extends SpecialPage {
	...
	protected function getWizardHtml() {
		...
		.         '<div id="mwe-upwiz-flickrSelectlistContainer" class="ui-corner-all">'
		.			'<div id="mwe-upwiz-flickrSelectlist"></div>'
		.		  	'<button id="mwe-upwiz-select-flickr">' . wfMsg( "mwe-upwiz-add-file-0-free" ) . '</button>'
		.		  '</div>'
		...
		.					'<button id="mwe-upwiz-upload-ctrl-flickr">' . wfMsg( "mwe-upwiz-add-file-flickr" ) . '</button>'
		.            '</div>'
		.  	     	'</div>'
